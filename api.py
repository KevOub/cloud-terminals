...
def build_dockerfile():
    ...
    if status == 0:
        ...
        return "Build failed: Here is the stack trace: \n\n" + "".join(build_out)
...
def run_dockerfile():
    ...
    if status == 0:
        ...
        return f"failed to launch {container_name}. Probably forgot to build first Here is the stacktrace:\n {build_out}"
